 ...
 * "gu" e "den", por exemplo, ocorre da seguinte forma. Primeiro é identificado
 * o conjunto de palavras que contém tais sequências, digamos C1 e C2, respectivamente. Identificamos
...
public class Indice {
    ...
    private Map<String, Set<Integer>> dicionario;
    private Map<String, Set<String>> duasLetras;

    public Indice(String[] sentencas) {
        dicionario = montaDicionario(sentencas);
        duasLetras = montaIndice(dicionario);
    }
     ...
     * @param dicionario
     */
    public static Map<String, Set<String>> montaIndice(Map<String, Set<Integer>> dicionario) {
     ...
     *
     * @return Dicionário para conjunto de índices das sentenças que contém
     * a palavra (chave) ou entrada em questão. Uma chave desse dicionário
     * necessariamente é uma palavra de uma ou mais sentenças e toda palavra
     * de qualquer sentença é uma chave.
     *
     * @param sentencas Sentenças para as quais é produzido um índice que as
     *                  indentifica por palavra.
     */
    public static Map<String, Set<Integer>> montaDicionario(String[] sentencas) {
